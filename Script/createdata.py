...
wargear = [
    ...
    ("(1, 4)", "Raw Axe", "()", 3, 0, 2, 0, 4, 0, 0, 0, 0, 0, 0),
    ...
    ("(1, 13)", "Orb of Shock", "()", 0, 0, 0, 6, 10, 0, 0, 0, 0, 0, 0),
    ("(1, 14)", "Orb of the Storm", "()", 0, 0, 0, 6, 10, 0, 0, 0, 0, 0, 0),
...
models = [
    ("(0, 0)", "Captain", "('Focus Aura')", 4, 4, 5, 3, "('CHARACTER', 'INFANTRY', 'CAPTAIN')", 9, 0, 6, 5, 75, 1,
     "portrait_sprite.png", 5, "(1, 1)", "placeholder_sprite.png", 1, "(32, 32)", 4, 4, "(21, 3, 22, 23)"),
    ...
    ("(0, 14)", "Pyro-Tech Gunner", "('Repair artillery')", 1, 4, 2, 0, 
     ...
     "(1, 1)", "placeholder_sprite.png", 1, "(32, 32)", 4, 4, "(0, 3, 22, 23)"),
    ...
    ("(0, 16)", "Brotherhood APC", "('Explodes', 'Degrades')", 3, 4, 10, 0, 
     ...
     "placeholder_sprite.png", 1, "(32, 32)", 6, 8, "(25)"),
    ("(0, 17)", "Pyro-Heavy Chopper", "('Explodes', 'Degrades', 'Steady')", 3, 4, 10, 0, 
     ...
     "(6, 6)", "paladins_pyro_heavy_chopper_sprite.png", 1, "(32, 32)", 6, 6, "(16, 16, 32, 32)"),
...
models = [
    ...
    ("(1, 7)", "Gunner", "('Orcish Pride')", 1, 4, 1, 0, "('INFANTRY', 'GUNNER SQUAD')", 8, 0, 6, 4, 13, 1,
     "portrait_sprite.png", 4, "(1, 1)", "placeholder_sprite.png", 1, "(32, 32)", 4, 4, "(5, 1, 2)"),
    ...
    ("(1, 12)", "Orc Heavy", "('Orcish Pride')", 2, 4, 1, 0, "('INFANTRY', 'DEMOLITIONS SQUAD')", 8, 0, 6, 4, 18, 1,
     "portrait_sprite.png", 3, "(1, 1)", "placeholder_sprite.png", 1, "(32, 32)", 4, 4, "(21, 0, 2)"),
    ("(1, 13)", "Orc Heavy Leader", "('Orcish Pride')", 3, 4, 2, 0, "('INFANTRY', 'DEMOLITIONS SQUAD')", 9, 0, 6, 4,
      18, 1, "portrait_sprite.png", 3, "(1, 1)", "placeholder_sprite.png", 1, "(32, 32)", 4, 4, "(21, 0, 2)"),
    ...
    ("(1, 16)", "Duster", "('Explodes', 'Degrades', 'Hard to hit')", 3, 4, 8, 0, 
     ...
     "orc_duster_sprite.png", 1, "(32, 32)", 6, 6, "(5, 5)"),
...
units = [
    ...
    ("(1, 1)", "Storm Caller", 0, "(1)", "(4, 5, 6, 7)", 1),
